...
export default function InventoryDashboard({ params }: { params: Promise<{ id: string }> }) {
  const { id } = use(params);
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-300">
      ...
      <div className="grid grid-cols-4 gap-2 sm:gap-4 max-w-3xl mx-auto border-b border-slate-850 pb-4 w-full">
        {[
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <SVGHorizontalBarChart
                  ...
                  data={metrics.suppliers.slice(0, 5).map(sup => ({
                    label: sup.supplier,
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="rounded-xl border border-slate-800 bg-slate-950/20 p-5">
                  ...
                  <p className="text-2xl font-extrabold text-indigo-400 mt-1">
                    {(metrics.suppliers.reduce((sum, s) => sum + s.matchingRate, 0) / (metrics.suppliers.length || 1)).toFixed(1)}%
                  </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div className="rounded-xl border border-slate-800 bg-slate-950/20 p-5">
                  ...
                  <p className="text-2xl font-extrabold text-emerald-400 mt-1">
                    {(metrics.counters.reduce((sum, c) => sum + c.accuracyRate, 0) / (metrics.counters.length || 1)).toFixed(1)}%
                  </p>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-1 gap-4">
                <div className="rounded-xl border border-slate-800 bg-[#0c0e15]/40 p-5 space-y-1">
                  ...
                  <p className="text-[10px] text-slate-500 leading-normal">Sum of absolute discrepancy values across all line items.</p>
                </div>
              </div>
