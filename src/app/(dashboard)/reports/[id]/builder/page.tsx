...
export default function ReportBuilder({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="space-y-8 max-w-4xl animate-in fade-in duration-300">
      ...
      <div className="grid grid-cols-4 gap-2 sm:gap-4 max-w-3xl mx-auto border-b border-slate-800 pb-4 w-full">
        {[
